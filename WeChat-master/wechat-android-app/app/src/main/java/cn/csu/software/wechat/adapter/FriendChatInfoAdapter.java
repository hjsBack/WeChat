...
public class FriendChatInfoAdapter extends RecyclerView.Adapter {
    ...
    public class FriendChatInfoHolder extends RecyclerView.ViewHolder {
        ...
        public FriendChatInfoHolder(View itemView) {
            ...
            mFriendNameTextView = itemView.findViewById(R.id.tv_name_friend_chat_info);
            mFriendAvatarImageView = itemView.findViewById(R.id.iv_avatar_friend_chat_info);
            mFriendMessageTextView = itemView.findViewById(R.id.tv_message_friend_chat_info);
            mSendTimeTextView = itemView.findViewById(R.id.tv_send_time_friend_chat_info);
        }
    }
}
